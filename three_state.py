...
def declare_functions():
    ...
    Rule('Divide_A', A >> A + A, k_dip_A)
    Rule('Death_A',  A >> None,  k_dip_A)
    Rule('Divide_B', B >> B + B, k_dip_B)
    Rule('Death_B',  B >> None,  k_dip_B)
    Rule('Divide_C', C >> C + C, k_dip_C)
    Rule('Death_C',  C >> None,  k_dip_C)
