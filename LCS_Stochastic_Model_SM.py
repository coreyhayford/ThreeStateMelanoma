...
from pysb.macros import *  # import macros for more complicated reactions
from pysb.bng import *  # import everything from BioNetGen
from pysb.integrate import odesolve  # import something to solve the ODE
import pylab as pl  # import pylab
from numpy import linspace  # import function to set up space for plotting
from sympy import sympify
import numpy as np  # import numpy for scientific stuff


#
# prob = [.3, .6, .1]
# num_cells = numpy.random.poisson(5)
#
